 ...
 /* const [showButtons, setShowButtons] = useState(false);*/
  return (
    ...
    <section ref = {ref} className='relative z-10 mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]' id = "home">
      <div className="flex items-center justify-center">
        ...
        >
          <Image
            ...
            quality={95}
            priority={true}
            className="rounded-full h-58 w-58 border-[0.05rem] border-[#2a303c] shadow-xl object-cover"
          />
        </motion.div>
      ...
      <motion.h1 className="text-white mt-10 mb-10 px-4 text-4xl font-medium leading-[1.5]"
